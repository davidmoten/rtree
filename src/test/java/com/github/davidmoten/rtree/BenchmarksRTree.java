...
public class BenchmarksRTree {
    ...
    public void rStarTreeSearchOfGreekDataPointsMaxChildren128() {
        starTreeM128.search(Geometries.rectangle(500, 500, 510, 510)).count().toBlocking().single();
    }
    ...
    private void search(RTree<Object> tree) {
        tree.search(Geometries.rectangle(500, 500, 510, 510)).count().toBlocking().single();
    }
