...
public class QuadraticSplitterTest {
	...
	public void testWorstCombinationOn3() {
		...
		final Mbr r2 = r(100);
		final Mbr r3 = r(3);
		final Pair<Mbr> pair = QuadraticSplitter.worstCombination(Arrays
				.asList(r1, r2, r3));
	...
	public void testGetBestCandidateForGroup1() {
		...
		final Mbr r = QuadraticSplitter.getBestCandidateForGroup(list, group,
				Util.mbr(group));
		assertEquals(r1, r);
	}
	...
	public void testSplit3() {
		...
		final Mbr r5 = r(103);
		final Mbr r6 = r(104);
		final ListPair<Mbr> pair = q.split(Arrays
