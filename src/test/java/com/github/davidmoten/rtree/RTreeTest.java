...
public class RTreeTest {
	...
	public void testVisualizer() {
		...
		RTree<Object> tree2 = RTree.maxChildren(maxChildren).star().create()
				.add(entries);
		tree2.visualize(600, 600, view).save(new File("target/tree2.png"),
				"PNG");
	}
	...
	public void testVisualizerWithGreekData() {
		...
		tree.visualize(2000, 2000, view).save(new File("target/greek.png"),
				"PNG");
		...
		RTree<Object> tree2 = RTree.maxChildren(maxChildren).star().create()
				.add(entries);
		tree2.visualize(2000, 2000, view).save(new File("target/greek2.png"),
				"PNG");
	}
