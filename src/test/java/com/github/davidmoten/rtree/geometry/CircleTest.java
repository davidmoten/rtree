...
public class CircleTest {
    ...
    public void testIntersects() {
        Circle circle = circle(0, 0, 1);
        assertTrue(circle.intersects(Geometries.rectangle(0, 1, 0, 1)));
    }

    @Test
    public void testIntersects2() {
        Circle circle = circle(0, 0, 1);
        assertFalse(circle.intersects(Geometries.rectangle(0, 1.1, 0, 1.1)));
    }

    @Test
    public void testIntersects3() {
        Circle circle = circle(0, 0, 1);
        assertFalse(circle.intersects(Geometries.rectangle(1, 1, 1, 1)));
    }
}
